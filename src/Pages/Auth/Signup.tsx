          ...
          <Left>
            <Holder onSubmit={onHandleSubmit}>
              <ImageHolder>
                ...
                <But htmlFor="pix">Upload Image</But>
              </ImageHolder>
              <Mid>
                <Hold>
                  <InputHold mg="">
                    <Name>Name:</Name>
                    <Input
                      placeholder="eg?. Joe Micheal"
                      {...register("name")}
                    />
                    {errors.name && <Error>Please provide a name</Error>}
                  </InputHold>
                  <InputHold mg="20px">
                    <Name>Email:</Name>
              ...
              <Word>
                Have an account? <Sign to="/signin">Sigin</Sign>
              </Word>
            </Holder>
          </Left>
          <Right>
